...
const { broadcasterAuth, viewrAuth, checkAuth } = require('./middleware')
...
app.get(['/broadcast'], broadcasterAuth, (req, res) => {
...
app.get(['/viewer'], viewrAuth, (req, res) => {
...
app.get(['/NA-:broadcastId/:token'], checkAuth, viewrAuth, (req, res) => {
    ...
    if (role === 'broadcaster')
        ...
        return res.sendFile(html.viewer);
